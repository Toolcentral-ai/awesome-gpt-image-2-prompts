...
Este repositório organiza modelos de prompts do GPT Image 2 e metadados de categorias para fluxos de geração de imagens, navegação de prompts, pesquisa de casos e agent skills.

Site principal de prompts: https://model-prompt-lab.com/models/gpt-image-2/prompts

Exemplo de pesquisa semântica: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

Os links de categoria usam `q=<category>` em vez do formato antigo `categories=<category>`. A pesquisa do Model Prompt Lab entende estes termos semanticamente e recupera casos GPT Image 2 relacionados.
