# GPT Image 2 Prompts — Português (Brasil)

[English](../README.md)

Este repositório organiza modelos de prompts do GPT Image 2 e metadados de categorias para workflows de geração de imagens, navegação de prompts, busca de casos e agent skills.

Site principal de prompts: https://model-prompt-lab.com/models/gpt-image-2/prompts

Exemplo de busca semântica: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

Os links de categoria usam `q=<category>` em vez do formato antigo `categories=<category>`. A busca do Model Prompt Lab entende esses termos semanticamente e recupera casos GPT Image 2 relacionados.

## Conteúdo do repositório

- Modelos de prompts: 7,902
- Categorias de origem: 70
- Gerado em: `2026-05-27T16:53:33.984453998Z`
- Versão do schema: `2026-05-24`
