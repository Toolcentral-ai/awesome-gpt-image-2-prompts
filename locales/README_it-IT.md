# GPT Image 2 Prompts — Italiano

[English](../README.md)

Questo repository organizza template di prompt GPT Image 2 e metadati di categoria per workflow di generazione immagini, navigazione dei prompt, ricerca di case e agent skill.

Sito principale dei prompt: https://model-prompt-lab.com/models/gpt-image-2/prompts

Esempio di ricerca semantica: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

I link di categoria usano `q=<category>` invece del vecchio formato `categories=<category>`. La ricerca di Model Prompt Lab interpreta questi termini semanticamente e recupera case GPT Image 2 pertinenti.

## Contenuto del repository

- Template di prompt: 7,902
- Categorie sorgente: 70
- Generato il: `2026-05-27T16:53:33.984453998Z`
- Versione schema: `2026-05-24`
