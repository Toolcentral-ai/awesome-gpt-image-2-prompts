...
รีโพซิทอรีนี้รวบรวมเทมเพลตพรอมป์ GPT Image 2 และเมทาดาทาหมวดหมู่ สำหรับเวิร์กโฟลว์สร้างภาพ การนำทางพรอมป์ การค้นหาเคส และ agent skill

เว็บไซต์พรอมป์หลัก: https://model-prompt-lab.com/models/gpt-image-2/prompts

ตัวอย่างการค้นหาเชิงความหมาย: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

ลิงก์หมวดหมู่ใช้ `q=<category>` แทนรูปแบบเก่า `categories=<category>` ระบบค้นหาของ Model Prompt Lab เข้าใจคำหมวดหมู่เชิงความหมายและเรียกคืน GPT Image 2 case ที่เกี่ยวข้องได้

## เนื้อหาในรีโพซิทอรี

- เทมเพลตพรอมป์: 7,902
- หมวดหมู่ต้นทาง: 70
- เวลาที่สร้าง: `2026-05-27T16:53:33.984453998Z`
- เวอร์ชัน Schema: `2026-05-24`
