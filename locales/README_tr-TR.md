# GPT Image 2 Prompts — Türkçe

[English](../README.md)

Bu depo, görüntü üretim iş akışları, prompt gezintisi, case araması ve agent skill kullanımı için GPT Image 2 prompt şablonlarını ve kategori metadatasını düzenler.

Ana prompt sitesi: https://model-prompt-lab.com/models/gpt-image-2/prompts

Semantik arama örneği: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

Kategori bağlantıları eski `categories=<category>` formatı yerine `q=<category>` kullanır. Model Prompt Lab araması bu kategori terimlerini semantik olarak anlar ve ilgili GPT Image 2 caselerini getirir.

## Repository içeriği

- Prompt şablonları: 7,902
- Kaynak kategoriler: 70
- Oluşturulma zamanı: `2026-05-27T16:53:33.984453998Z`
- Schema sürümü: `2026-05-24`
