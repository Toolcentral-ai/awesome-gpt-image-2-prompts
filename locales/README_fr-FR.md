# GPT Image 2 Prompts — Français

[English](../README.md)

Ce dépôt organise des modèles de prompts GPT Image 2 et des métadonnées de catégories pour les workflows de génération d’images, la navigation de prompts, la recherche de cas et les agent skills.

Site principal de prompts: https://model-prompt-lab.com/models/gpt-image-2/prompts

Exemple de recherche sémantique: https://model-prompt-lab.com/models/gpt-image-2/prompts?q=photography

Les liens de catégorie utilisent `q=<category>` au lieu de l’ancien format `categories=<category>`. La recherche Model Prompt Lab comprend ces termes de façon sémantique et retrouve les cas GPT Image 2 pertinents.

## Contenu du dépôt

- Modèles de prompts: 7,902
- Catégories source: 70
- Généré le: `2026-05-27T16:53:33.984453998Z`
- Version du schema: `2026-05-24`
